    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-compact nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!------- MENU # 1 ------->
                <?php if (Yii::$app->controller->id == 'inicio' || Yii::$app->controller->id == 'categorias' || Yii::$app->controller->id == 'productos') {
                ...
                <li class="<?= $li; ?>"><a class="<?= $a; ?>" href="#"><i class="nav-icon fas fa-list"></i>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        ?>
                        <li class="<?= $li; ?>"><a class="<?= $a; ?>" href="<?php echo Url::toRoute(['/productos/index']); ?>"><i class="nav-icon far fa-circle text-green"></i>
                                <p>Productos</p>
                            </a></li>
                        <!-------------------------------------------------->
                    </ul>
